...
public class LudoBoardAndPlayerFactory {

	Board board;
	List<LudoPlayer> players;
	int noPlayers;

	public LudoBoardAndPlayerFactory(){
		this(4);
	}

	
	public LudoBoardAndPlayerFactory(int noplayers){
	...
	private List<BoardLocation> createBoardLocations() {
		...
		try {
			List<String> listOfPositions = LudoFileHandler
					.readCoordinate();
