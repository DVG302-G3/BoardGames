...
public LudoMoveController(LudoGameState gameState) {
	...
	public Boolean proposeMove(Move move) {
		...
		case MOVE_INVALID_CANT_LAPSE_YOUR_OWN_PIECE:
			gameState.setMessage(LudoStaticValues.MOVE_INVALID_CANT_LAPSE_YOUR_OWN_PIECE);
			return false;
		case MOVE_INVALID_CANT_PASS_A_BLOCK:
			gameState.setMessage(LudoStaticValues.MOVE_INVALID_CANT_PASS_A_BLOCK);
			return false;
		...
		case MOVE_INVALIDA_BOARDLOCATION_ALREADY_OCCUPIED:
			gameState.setMessage(LudoStaticValues.MOVE_INVALIDA_BOARDLOCATION_ALREADY_OCCUPIED);
			return false;
		default: {
			gameState.setMessage("");
			return false;
